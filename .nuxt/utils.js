...
export async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      error: context.error,
      base: '/',
      env: {"CTF_SPACE_ID":"lqfz861vkmy8","CTF_CDA_ACCESS_TOKEN":"47cdb0f267093d530dfc96006da2bfc088cedc7cf8779d133335adc45ed2158c","CTF_PERSON_ID":"15jwOBqpxqSAOy2eOO4S0m","CTF_BLOG_POST_TYPE_ID":"blogPost","CTF_HERO_BANNER_TYPE_ID":"6gPJoCSR8IQCuSQGoIGiia"}
    }
    // Only set once
